  ...
  const resources = [
    {
      ...
      description: 'An insight into the creative origins, core themes, and narrative structure of Mission: Aurelia – written by the creator to guide collaborators and producers through the project's heart.',
